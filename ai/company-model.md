...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "MICHELIN") |
| group        | string   | Parent company group (e.g. "Michelin Group") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/sebiboga/michelin-romania-sa-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)